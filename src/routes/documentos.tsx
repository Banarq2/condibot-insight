...
const recent = [
  {
    name: "Resolución SEMARNAT 2024-0457.pdf",
    type: "Resolución condicionada",
    project: "Banco El Mirador",
    pages: 47,
    status: "Procesado",
    date: "2026-05-28",
  },
  {
    name: "MIA Banco El Mirador.pdf",
    type: "MIA",
    project: "Banco El Mirador",
    pages: 312,
    status: "Procesado",
  ...
  {
    name: "Catálogo Impactos VMO 2025.pdf",
    type: "Catálogo IA",
    project: "General",
    pages: 84,
    status: "Procesado",
  ...
  {
    name: "Resolución Planta Norte.pdf",
    type: "Resolución condicionada",
    project: "Planta Trituradora Norte",
    pages: 38,
    status: "OCR en proceso",
    date: "2026-06-02",
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        description="Sube MIA, resoluciones condicionadas, catálogos de impactos o evidencias de cumplimiento."
      />
          ...
          <CardContent className="space-y-4">
                ...
                <Select value={docType} onValueChange={setDocType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="resolucion">
                      Resolución / Autorización Condicionada
                    </SelectItem>
            ...
            <label className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-primary/40 bg-primary/5 px-6 py-12 text-center transition hover:bg-primary/10">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Acepta PDF digital o escaneado. OCR automático.
                </p>
              </div>
            ...
            <div className="grid gap-2 rounded-lg border bg-muted/30 p-4 text-sm">
              ...
              <ul className="grid grid-cols-2 gap-1 text-xs text-muted-foreground">
                ...
                <li className="flex items-center gap-1">
                  <CheckCircle2 className="h-3 w-3 text-success" />
                  Página fuente y texto original
                </li>
              </ul>
            </div>
              ...
              <div key={d.name} className="flex items-start gap-3 rounded-md border bg-card p-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {d.type} · {d.pages} págs · {d.project}
                  </p>
                  <p className="mt-1 text-[11px] text-muted-foreground">
                    {d.date} ·{" "}
                    <span
                      className={
                        d.status === "Procesado" ? "text-success" : "text-warning-foreground"
                      }
                    >
                      {d.status}
                    </span>
